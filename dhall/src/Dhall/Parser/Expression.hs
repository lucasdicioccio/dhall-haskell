  ...
  where
    ...
    bytesLiteral =
        ( do
            ...
            return (BytesLit (ByteString.pack bytes))
        )
            <?> "literal"
    ...
    unionType =
        ( do
            ...
            nonEmptyUnionType <|> emptyUnionType
        )
            <?> "literal"
    ...
    listLiteral =
        ( do
            ...
            nonEmptyListLiteral <|> emptyListLiteral
        )
            <?> "literal"
